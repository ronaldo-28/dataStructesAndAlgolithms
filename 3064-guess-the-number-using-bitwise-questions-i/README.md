<h2><a href="https://leetcode.com/problems/guess-the-number-using-bitwise-questions-i">3370. Guess the Number Using Bitwise Questions I</a></h2><h3>Medium</h3><hr><p>There is a number <code>n</code> that you have to find.</p>
