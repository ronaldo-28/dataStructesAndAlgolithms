<h2><a href="https://leetcode.com/problems/maximum-number-that-makes-result-of-bitwise-and-zero">3433. Maximum Number That Makes Result of Bitwise AND Zero</a></h2><h3>Medium</h3><hr>Given an integer <code>n</code>, return the <strong>maximum</strong> integer <code>x</code> such that <code>x &lt;= n</code>, and the bitwise <code>AND</code> of all the numbers in the range <code>[x, n]</code> is 0.
<p>&nbsp;</p>
